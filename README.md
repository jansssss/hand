...
- **배경 지우기** — MediaPipe `ImageSegmenter`(selfie multiclass)로 손만 남기고 종이색으로 갈아끼운 뒤 손을 중심으로 3:4로 잘라낸다. 브라우저에서 돌고 서버로 나가지 않는다. 마스크가 미덥지 않으면(점유율 6% 미만이거나 92% 초과) 원본을 그대로 쓰고, 촬영 화면의 토글로 끌 수 있다
